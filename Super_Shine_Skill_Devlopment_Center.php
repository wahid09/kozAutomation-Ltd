...
$message = '';
$complete_project_result = $obj_app->select_all_complete_published_project_super_info();
$ongoing_project_result = $obj_app->select_all_ongoing_published_project_super_info();
$upcoming_project_result = $obj_app->select_all_upcoming_published_project_super_info();
?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="text-center">
                            <h1>Super Shine Skill Development Center</h1>
                        </div>
                                                            ...
                                                            while ($published_complete_project = mysqli_fetch_assoc($complete_project_result)) {
                                                                ...
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img-thumbnail mar_bot">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-center" >
                                                                        <div class="img-responsive img-thumbnail select"><a href="project_details_super.php?id=<?php echo $project_id; ?>"><img src="assets/<?php echo $image_one; ?>" alt="" class="img-responsive" style="width: 300px; height: 300px;"></a></div>
                                                                    </div>
