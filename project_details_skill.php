...
$message = '';
$project_id = $_GET['id'];
$project_result_by_id = $obj_app->select_published_project_skill_details_by_id($project_id);
?>
    ...
    <body class="no-trans"> 
        ...
        <div class="back_color menu_pad"><br><br><br><br><br><br><br><br><br>
            <div class="container">
                ...
                <br><br><br>
                <a href="Skill_Tech_Bd_Ltd.php"><button type="button" class="btn btn-danger">Back</button></a>
                <br><br><br>
            </div>
