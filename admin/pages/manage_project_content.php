...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'unpublished') {
        $message = $obj_project->unpublished_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'published') {
        $message = $obj_project->published_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'delete') {
        $message = $obj_project->delete_project_info_by_id($project_id);
    }
}

$query_result = $obj_project->select_all_project_info();
?>
                        ...
                        while ($all_project = mysqli_fetch_assoc($query_result)) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center"><?php
                                    ...
                                    ?></td>
                                <td class="center">
                                    <a href="view_project.php?id=<?php echo $project_id; ?>" class="btn btn-success" title="View">
                                    ...
                                    <?php } ?>
                                    <a href="edit_project.php?id=<?php echo $project_id; ?>" class="btn btn-warning" title="Edit">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="update_image.php?id=<?php echo $project_id; ?>" class="btn btn-info" title="Update all Image of this project">
