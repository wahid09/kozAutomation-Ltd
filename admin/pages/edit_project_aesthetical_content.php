...
if (isset($_POST['btn'])) {
    ...
    $message = $obj_aesthetical->update_project_info($_POST);

}

$project_id = $_GET['id'];

$query_result = $obj_aesthetical->select_project_info_by_id($project_id);
            ...
            <div class=" col-lg-12 panel-heading page-header ">
                ...
                <div class="col-lg-1">
                    ...
                    <p>
                        ...
                        <a href="manage_project_aesthetical.php" class="btn btn-primary" title="back to manage project">
