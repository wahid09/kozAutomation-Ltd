...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'unpublished') {
        ...
        $message = $obj_smart->unpublished_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'published') {

        $message = $obj_smart->published_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'delete') {

        $message = $obj_smart->delete_project_info_by_id($project_id);
    }
}



$query_result = $obj_smart->select_all_project_info();
?>
                        ...
                        while ($all_project = mysqli_fetch_assoc($query_result)) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    ...
                                    <a href="view_project_smart.php?id=<?php echo $project_id; ?>" class="btn btn-success" title="View">
                                    ...
                                    <a href="edit_project_smart.php?id=<?php echo $project_id; ?>" class="btn btn-warning" title="Edit">
