...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'unpublished') {
        ...
        $message = $obj_skill->unpublished_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'published') {

        $message = $obj_skill->published_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'delete') {

        $message = $obj_skill->delete_project_info_by_id($project_id);
    }
}

$project_id = $_GET['id'];

$query_result = $obj_skill->select_project_info_by_id($project_id);
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class=" panel-heading text-center">
                <h3 class="text-primary">Skill Tech Bd Ltd</h3>
            </div>
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a href="manage_project_skill.php" class="btn btn-primary" title="back to manage project">
                                ...
                                <a href="edit_project_skill.php?id=<?php echo $project_id; ?>" class="btn btn-warning" title="Edit">

                                    <span class="glyphicon glyphicon-edit"></span>

                                </a>

                                <a href="update_image_skill.php?id=<?php echo $project_id; ?>" class="btn btn-info" title="Update all Image of this project">
