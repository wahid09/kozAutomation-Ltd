...
if (isset($_GET['status'])) {
    ...
    if ($_GET['status'] == 'unpublished') {
        ...
        $message = $obj_super->unpublished_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'published') {

        $message = $obj_super->published_project_info_by_id($project_id);
    } else if ($_GET['status'] == 'delete') {

        $message = $obj_super->delete_project_info_by_id($project_id);
    }
}



$query_result = $obj_super->select_all_project_info();
?>
                        ...
                        while ($all_project = mysqli_fetch_assoc($query_result)) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    ...
                                    <a href="view_project_super.php?id=<?php echo $project_id; ?>" class="btn btn-success" title="View">
                                    ...
                                    <a href="update_image_super.php?id=<?php echo $project_id; ?>" class="btn btn-info" title="Update all Image of this project">
