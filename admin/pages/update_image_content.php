<?php
if (isset($_POST['btn'])) {
    $message = $obj_project->update_image_info($_POST);
}
$project_id = $_GET['id'];
$query_result = $obj_project->select_project_info_by_id($project_id);
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class=" col-lg-12 panel-heading page-header ">
                <div class="col-lg-2">
                    <p>
                        <a href="manage_project.php" class="btn btn-primary" title="back to manage project">
                ...
                <div class="col-lg-10 text-center lead">
                    <u class="text-success">Update Image</u><br/>
                </div>
            </div>
